...
```javascript
PATH_DELIMITER_POSIX = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-delimiter-posix@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-delimiter-posix@umd/bundle.js"></script>
```
