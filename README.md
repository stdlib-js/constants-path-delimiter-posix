...
```javascript
PATH_DELIMITER_POSIX = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-delimiter-posix@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-path-delimiter-posix/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-path-delimiter-posix/actions/workflows/test.yml?query=branch:v0.2.3
